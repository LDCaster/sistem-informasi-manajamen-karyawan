...
@section('content')
    <div class="panel flex items-center overflow-x-auto whitespace-nowrap p-3 text-primary">
        ...
        <h5 class="text-lg font-semibold dark:text-white-light">Ubah Resignasi Karyawan</h5>
    </div>
    ...
    <div class="panel flex items-center overflow-x-auto whitespace-nowrap p-3">
        <div class="container">
            <form action="{{ route('resignasi-karyawan.update', $karyawan->id) }}" method="POST"
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="mb-3">
                            ...
                            <input id="tanggal_keluar" type="date" name="tanggal_keluar" class="form-input"
                                value="{{ old('tanggal_keluar', $karyawan->editResignasi->tanggal_keluar ?? '') }}" />
                        </div>
                        <div class="mb-3">
                            ...
                            <textarea rows="2" class="form-textarea ltr:rounded-l-none rtl:rounded-r-none" id="keterangan_keluar"
                                name="keterangan_keluar">{{ old('keterangan_keluar', $karyawan->editResignasi->keterangan_keluar ?? '') }}</textarea>
                        </div>
                    </div>
                </fieldset>
