...
@section('content')
    ...
    <div x-data="exportTable">
        <div class="panel flex items-center overflow-x-auto whitespace-nowrap p-3 text-primary">
            ...
            <h5 class="text-lg font-semibold dark:text-white-light">Resignasi Karyawan</h5>
        </div>
        @if (session('success'))
            <!-- danger -->
                            ...
                            },
                            {
                                ...
                                render: (data, cell, row) => {
                                    ...
                                    <div class="flex items-center">
                                            <a href="/resignasi-karyawan/${row.cells[1].innerText}/edit/" class="ltr:mr-2 rtl:ml-2" x-tooltip="Edit">
