    ...
    <script>
        document.addEventListener('alpine:init', () => {
            ...
            Alpine.data('exportTable', () => ({
                datatable: null,
                users: @json($users), // Masukkan data user ke dalam script
                init() {

                    // Membuat data untuk tabel dari data user
                    const dataUser = this.users.map(user => {
                        // Ambil data pekerjaan user pertama
                        ...
                        return [
                            ...
                            user.status.toLowerCase().replace(/\b\w/g, char => char
                                .toUpperCase()),
                            user.created_at, // Nama
                            // karyawan.sbu || '', // SBU (Dari data karyawan
                        ];
                    });
                    ...
                    this.datatable = new simpleDatatables.DataTable('#myTable', {
                        data: {
                            ...
                            data: dataUser, // Menampilkan data user
                        },
                        perPage: 10,
                        ...
                        columns: [{
                            ...
                            },
                            {
                                ...
                                render: (data, cell, row) => {
                                    return `     <div class="flex items-center">
                                            <a href="/users/${row.cells[1].innerText}/edit/" class="ltr:mr-2 rtl:ml-2" x-tooltip="Edit">
                            ...
                            {
                                select: 5, // Kolom untuk Status user
                                render: (data, cell, row) => {
