                    ...
                    this.datatable = new simpleDatatables.DataTable('#myTable', {
                        data: {
                            headings: ['<div class="text-center">Action</div>', 'No', 'Nama',
                                'NIP', 'Bagian', 'Dept',
                                'Status Kontrak', 'Kontrak Lanjutan Ke-', 'Tanggal Mulai',
                                'Tanggal Akhir'
                            ],
                            data: [
                                ['', 1, 'Caroline Jensen', '198764321', 'Finance',
                                    'POLARAX', 'PKWT', 3, '2023-01-01', '2024-01-01'
                                ],
                                ['', 2, 'Celeste Grant', '123457890', 'HR', 'MANGLO',
                                    'PKWT/PKWTT', 1, '2022-06-15', '2023-06-15'
                                ],
                                ['', 3, 'Daniel Smith', '876543210', 'IT', 'TECHNO',
                                    'PKWTT', 5, '2020-05-10', '2025-05-10'
                                ],
                                ['', 4, 'Emma Watson', '1122334455', 'Marketing', 'GLOBEX',
                                    'PKWTT', 2, '2021-03-01', '2023-03-01'
                                ],
                                ['', 5, 'John Doe', '9988776655', 'Operations', 'INNOTECH',
                                    'PKWT/PKWTT', 4, '2019-09-01', '2024-09-01'
                                ]
                            ],
                        },
                        perPage: 10,
                        ...
                        columns: [{
                            ...
                            {
                                select: 7, // Kolom ke-7 (Status Kontrak)
                                render: (data, cell, row) => {
