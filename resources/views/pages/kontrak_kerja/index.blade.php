...
@section('content')
    ...
    <div x-data="exportTable">
        <div class="panel flex items-center overflow-x-auto whitespace-nowrap p-3 text-primary">
            ...
            <h5 class="text-lg font-semibold dark:text-white-light">Kontrak Kerja</h5>
        </div>
        @if (session('success'))
            <!-- danger -->
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('exportTable', () => ({
                datatable: null,
                kontrakkers: @json($kontrakkerja), // Pass the kontrakkerja data to Alpine.js
                init() {
                    // Map the kontrakkerja data into a format suitable for the table
                    const dataKontrak = this.kontrakkers.map(kontrak => {
                        const karyawan = kontrak.karyawan || {};
                        ...
                        return [
                            ...
                            karyawan.nip || '', // NIP
                            karyawan.nama || '', // Nama
                            kontrak.jenis_kontrak || '', // Jenis Kontrak
                            kontrak.status_kontrak_lanjutan ||
                            '', // Status Kontrak Lanjutan
                            kontrak.tanggal_awal_kontrak_lanjutan ||
                            '', // Tanggal Awal Kontrak Lanjutan
                            kontrak.tanggal_akhir_kontrak_lanjutan ||
                            '', // Tanggal Akhir Kontrak Lanjutan
                        ];
                    });
                    ...
                    this.datatable = new simpleDatatables.DataTable('#myTable', {
                        data: {
                            headings: ['<div class="text-center">Action</div>', 'No', 'NIK',
                                'NIP', 'Nama', 'Jenis Kontrak', 'Kontrak Lanjutan Ke-',
                                'Tanggal Awal Kontrak Lanjutan',
                                'Tanggal Akhir Kontrak Lanjutan'
                            ],
                            data: dataKontrak, // Use the mapped data
                        },
                        perPage: 10,
                        ...
                        columns: [{
                            ...
                            },
                            {
                                ...
                                render: (data, cell, row) => {
                                    return `<div class="flex items-center">
                                                 <a href="/kontrak-kerja/${row.cells[1].innerText}/edit/" class="ltr:mr-2 rtl:ml-2" x-tooltip="Edit">
                            ...
                            {
                                select: 6, // Kolom ke-7 (Status Kontrak)
                                render: (data, cell, row) => {
